...
class ReportController extends Controller
{
    ...
    public function getlistOfJobExcel(Request $request)
    {
        ...
        return $this->excelService->getlistOfJobExcel($validated);
    }

    // fetch applicant on the excel file all applicant
    public function getApplicantExcel(Request $request)
    {
        ...
        return $this->excelService->getApplicantExcel($validated);
    }

    // fetch applicant on the excel file qualified
    public function getApplicantQualifiedExcel(Request $request)
    {
        ...
        return  $this->excelService->getApplicantQualifiedExcel($validated);
    }

    // fetch applicant on the excel file unqualified
    public function getApplicantUnQualifiedExcel(Request $request)
    {
        $validated = $request->validate([
            'post_date' => 'required',
        ]);

        return $this->excelService->getApplicantUnQualifiedExcel($validated);
    }
